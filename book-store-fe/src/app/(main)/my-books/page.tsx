    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-100 gap-4">
                <p className="text-red-600 dark:text-red-400">Failed to load your books. Please try again.</p>
            ...
            <div className="space-y-6">
                ...
                {books.length === 0 ? (
                    <div className="flex flex-col items-center justify-center min-h-100 gap-4">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-lg">You haven't added any books yet</p>
                        <Button asChild>
